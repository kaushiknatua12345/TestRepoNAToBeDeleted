...
describe('CrudlogicService Test Suite', () => {
  ...
  it('should properly initialize HTTP client and API URL', () => {
    // Test that the service has initialized with HttpClient
    expect(service['http']).toBeTruthy();
    // Verify the API URL through a request
    service.getAllUsers().subscribe();
